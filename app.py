...
from visualization import generate_cluster_profiles, plot_segmentation_distribution, plot_rfm_comparison, plot_segment_sizes, plot_segment_revenue_percentage
import openai
